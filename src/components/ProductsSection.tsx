...
export const ProductsSection = () => {
  ...
  const products = [
    {
      ...
      description: "A playful, intelligent companion designed for children aged 3–16.",
      features: [
    ...
    },
    {
      ...
      description: "An institutional solution built to empower schools, teachers, and classrooms.",
      features: [
    ...
    },
    {
      id: "robot",
      title: "A-L-I Robot",
      description: "A physical robotic companion that brings A-L-I to life in the real world.",
      features: [
  ...
  return (
    <section id="products" className="py-24 bg-secondary/30 dark:bg-background">
                  ...
                  <div className="w-full md:w-2/5 flex-shrink-0">
                    <div className="aspect-square rounded-xl bg-black/10 dark:bg-white/5 flex items-center justify-center border border-primary/20">
                      <div className="text-center text-muted-foreground p-4">
                        ...
                        <p className="text-sm mt-2">Product image will be placed here</p>
                      </div>
                    </div>
                  </div>
